                    ...
                    <form action="" class="form-horizontal" method="post" enctype="multipart/form-data"> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <br><img src="product_images/<?php echo $p_img1; ?>" width="70" height="70" class="img-responsive">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <br><img src="product_images/<?php echo $p_img2; ?>" width="70" height="70" class="img-responsive">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <br><img src="product_images/<?php echo $p_img3; ?>" width="70" height="70" class="img-responsive">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="product_desc" id="" cols="28" rows="6" class="form-control"><?php echo $p_desc; ?></textarea>
                        </div>
                        <div class="form-group">
                            <input type="submit" name="update" value="Edit Product" class="btn btn-primary form-control">
                        </div>
                    </form>
                </div>
            </div>
